...
ARGS = None
COMMAND_STRING = "gimp -i -b '(python-fu-draw-line RUN-NONINTERACTIVE \"{}\" {} {} " \
                 "{} {} {} {} {} {} {} {})' -b '(gimp-quit 1)'"
...
def main():
    run_plugin_command = COMMAND_STRING.format(ARGS.name, ARGS.size, ARGS.r,
                                               ...
                                               ARGS.y2, ARGS.brush_size)
    os.system(run_plugin_command)


def draw_line(name, size, r, g, b, a, x1, y1, x2, y2, brush_size):
    run_plugin_command = COMMAND_STRING.format(name, size, r, g, b, a, x1, y1, x2, y2, brush_size)
    os.system(run_plugin_command)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--brush_size", type=float, help="(0 - 1)")
